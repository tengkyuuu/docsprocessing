...
<body>
    ...
    <?php
        ...
        $fname = $lname = $email = $password = $department = $position = "";
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql_users = "INSERT INTO users (FirstName, LastName, Email, Password, Role) VALUES (?, ?, ?, ?, ?)";

            if ($stmt_users = $conn->prepare($sql_users)) {
                $stmt_users->bind_param("sssss", $param_fname, $param_lname, $param_email, $param_password, $param_role);

                $param_fname = $fname;
                $param_lname = $lname;
                $param_email = $email;
                $param_password = password_hash($password, PASSWORD_DEFAULT);
                $param_role = "staff"; // Set the role to "staff"
                ...
                if ($stmt_users->execute()) {
                    ...
                    $sql_staff = "INSERT INTO staff (userID, Department, Position) VALUES (?, ?, ?)";

                    if ($stmt_staff = $conn->prepare($sql_staff)) {
                        $stmt_staff->bind_param("iss", $param_userID, $param_department, $param_position);
