                    ...
                    <input type="text" id="searchInput" placeholder="Search...">
                        ...
                        <thead>
                            ...
                            <tbody>
                                ...
                                // SQL query to fetch staff information
                                $sql = "SELECT u.UserID, CONCAT(u.FirstName, ' ', u.LastName) AS FullName, u.Email, s.position AS Position, s.department AS DepartmentName
                                        FROM users u
                                ...
                                if ($result->num_rows > 0) {
                                    ...
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        echo "<td>";
                                        echo "<button onclick=\"toggleEditForm(" . $row['UserID'] . ", '" . $row['FullName'] . "', '" . $row['Email'] . "', '" . $row['Position'] . "', '" . $row['DepartmentName'] . "')\">";
                                        echo "<i class='fas fa-edit'></i>"; // Edit icon
                                        echo "</button>";
                                        echo "<button onclick=\"confirmDelete(" . $row['UserID'] . ")\">";
                                        echo "<i class='fas fa-trash-alt'></i>"; // Delete icon
                                        echo "</button>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ...
                                    echo "<tr><td colspan='4'>No staff users found</td></tr>";
                                }
