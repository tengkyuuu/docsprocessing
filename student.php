                ...
                <input type="text" id="searchInput" placeholder="Search...">
                    <table id="dataTable">
                        ...
                        <?php
                            ...
                            // SQL query to fetch student information including email and program name
                            $sql = "SELECT u.Email, s.studentID, CONCAT(u.FirstName, ' ', u.LastName) AS FullName, p.ProgramName, s.currentYear 
                                    FROM users u
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td>";
                                    // Assuming you want to edit programs associated with students
                                    echo "<button class='edit-program-btn' onclick='toggleEditForm(\"" . $row['studentID'] . "\", \"" . $row['ProgramName'] . "\")'><i class='fa-solid fa-edit'></i></button>";
                                    echo "<button onclick='confirmDelete(\"" . $row['studentID'] . "\")'><i class='fa-solid fa-trash'></i></button>";
                                    echo "</td>";
                                    echo "</tr>";
                                }
                            } else {
